...
class ModelDesignBanner extends Model {
    ...
    public function __construct($registry) {
        ...
        $this->addDescriptionColumnIfNotExist();
    }

    /* Add Column Description in table tablePrefix_banner_image if column not exist */

    private function addDescriptionColumnIfNotExist() {

...
$_['help_whatsapp']                = 'This field is for placing the <xmp><a href></xmp> of the user registered on whatsapp to appear as a contact in the lower left corner of the main page of the store';
$_['help_facebook']                = 'This field is for placing the <xmp><url></xmp> of the Store or User registered on Facebook';
$_['help_instagram']               = 'This field is for placing the <xmp><url></xmp> of the Store or User registered on Instagram';
$_['help_youtube']                 = 'This field is for placing the <xmp><url></xmp> of the Store or User registered on Youtube';
